...
<section class="container-fluid padding-top-3x padding-bottom-3x">
    ...
    <h1 class="space-top-half">Sillas operativas</h1>
    ...
    <div class="row padding-top">
     ...
     <!-- .col-md-3.col-sm-4 -->
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
                ...
                <div class="column">
                    <p class="text-sm space-bottom-none">
                        <span class="text-gray">Cantidad de Productos:</span> <?php
                                                                                ...
                                                                                if ($result = mysqli_query($link, "SELECT id, modelo FROM sillasoperativas ORDER BY id")) {
            ...
            <div class="row">
                <?php
                $sentencia = $pdo->prepare("SELECT * FROM `sillasoperativas` ORDER BY precio desc");
                $sentencia->execute();
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="shop-item">
                            <div class="shop-thumbnail">
                                <a href="descripcion.php?id=<?php echo  $producto['id'];  ?>&pag=6" class="item-link"></a>
                                <img src="img/FOTOS OFFICE CLASS/SILLAS OPERATIVAS/<?php echo  $producto['modelo'];  ?>.png" style="width:190px; height: 318px;" alt="Shop item">
