...
<?php include 'cavecera.php'?>
    ...
    <section class="container-fluid padding-top-3x padding-bottom-3x">
      ...
      <h1 class="space-top-half">Sillas de diseño</h1>
     ...
     <!-- .col-md-3.col-sm-4 -->
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
          ...
          <div class="shop-bar">
            <div class="column">
              ...
              <span class="text-gray">Cantidad de articulos:</span> <?php 
                                ...
                                if ($result = mysqli_query($link, "SELECT id, modelo FROM sillasdediseño ORDER BY id")) {
          ...
          <div class="row">
          <?php
$sentencia=$pdo->prepare("SELECT * FROM `sillasdediseño` ORDER BY precio desc");
$sentencia->execute();
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="shop-item">
                <div class="shop-thumbnail">
                  ...
                  <img src="img/FOTOS OFFICE CLASS/SILLAS ESCOLARES/<?php echo  $producto ['modelo'];  ?>.png"  style="width:190px; height: 318px;" alt="Shop item">
