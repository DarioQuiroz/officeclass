...
-- Tiempo de generación: 25-04-2019 a las 23:56:38
...
(50, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:12:47', 'programacion@interactua-mkt.mx', '5373', 'vendido'),
(51, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:13:10', 'programacion@interactua-mkt.mx', '5373', 'vendido'),
(52, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:14:49', 'programacion@interactua-mkt.mx', '5373', 'vendido'),
(53, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:17:04', 'programacion@interactua-mkt.mx', '5373', 'vendido'),
(54, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:18:05', 'gil.q.c.dq@gmail.com', '5373', 'NOvendido'),
(55, 'j7b16p91lhlkddmj3e9t523enc', '', '2019-04-25 18:54:56', 'gil.q.c.dq@gmail.com', '5373', 'vendido');
...
ALTER TABLE `detalleventa`
  ...
  ADD CONSTRAINT `detalleventa_ibfk_10` FOREIGN KEY (`idproducto`) REFERENCES `sillasindustriales` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_11` FOREIGN KEY (`idproducto`) REFERENCES `sillasoperativas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_12` FOREIGN KEY (`idproducto`) REFERENCES `vancas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_2` FOREIGN KEY (`idproducto`) REFERENCES `tblproductos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_3` FOREIGN KEY (`idproducto`) REFERENCES `bancosaltos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_4` FOREIGN KEY (`idproducto`) REFERENCES `bancosdediseño` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_5` FOREIGN KEY (`idproducto`) REFERENCES `sillasdediseño` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_6` FOREIGN KEY (`idproducto`) REFERENCES `sillasdevisitantes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_7` FOREIGN KEY (`idproducto`) REFERENCES `sillasdirectivas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_8` FOREIGN KEY (`idproducto`) REFERENCES `sillasejecutivas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_9` FOREIGN KEY (`idproducto`) REFERENCES `sillasescolares` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
