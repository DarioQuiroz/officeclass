...
-- Tiempo de generación: 26-04-2019 a las 16:57:46
...
(3, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 10:37:50', 'gil.q.c.dq@gmail.com', '2326', 'vendido'),
(4, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:06:18', 'gil.q.c.dq@gmail.com', '8519', 'vendido'),
(5, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:10:58', 'gil.q.c.dq@gmail.com', '8519', 'vendido'),
(6, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:26:56', 'gil.q.c.dq@gmail.com', '21145', 'vendido'),
(7, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:29:39', 'gil.q.c.dq@gmail.com', '38083', 'vendido'),
(8, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:34:17', 'gil.q.c.dq@gmail.com', '44186', 'vendido'),
(9, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:51:36', 'gil.q.c.dq@gmail.com', '48901', 'vendido'),
(10, 'af066m4ueonjnlmkrim2n68j2g', '', '2019-04-26 11:54:00', 'gil.q.c.dq@gmail.com', '62441', 'vendido');
...
ALTER TABLE `detalleventa`
  ...
  ADD CONSTRAINT `detalleventa_ibfk_2` FOREIGN KEY (`idproducto`) REFERENCES `sillasescolares` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_3` FOREIGN KEY (`idproducto`) REFERENCES `sillasdevisitantes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_4` FOREIGN KEY (`idproducto`) REFERENCES `sillasdirectivas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_5` FOREIGN KEY (`idproducto`) REFERENCES `sillasejecutivas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_6` FOREIGN KEY (`idproducto`) REFERENCES `sillasescolares` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_7` FOREIGN KEY (`idproducto`) REFERENCES `sillasindustriales` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_8` FOREIGN KEY (`idproducto`) REFERENCES `sillasoperativas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `detalleventa_ibfk_9` FOREIGN KEY (`idproducto`) REFERENCES `vancas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
