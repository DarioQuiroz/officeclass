...
<?php include 'cavecera.php'?>
    ...
    <section class="container-fluid padding-top-3x padding-bottom-3x">
      ...
      <h1 class="space-top-half">Bancos altos</h1>
...
<!-- .col-md-3.col-sm-4 -->
        ...
        <?php
$sentencia=$pdo->prepare("SELECT * FROM `bancosaltos` ORDER BY precio desc");
$sentencia->execute();
          ...
          <div class="shop-bar">
            <div class="column">
              ...
              <span class="text-gray">Cantidad de Productos:</span> <?php 
                                ...
                                if ($result = mysqli_query($link, "SELECT id, modelo FROM bancosaltos ORDER BY id")) {
...
<div class="col-lg-3 col-md-4 col-sm-6">
  <div class="shop-item">
    ...
    <a href="descripcion.php?id=<?php echo  $producto ['id'];  ?>&pag=2" class="item-link"></a>
      <img src="img/FOTOS OFFICE CLASS/BANCOS ALTOS/<?php echo  $producto ['modelo'];  ?>.png" 
