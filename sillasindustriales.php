...
<?php include 'cavecera.php'?>
    ...
    <section class="container-fluid padding-top-3x padding-bottom-3x">
      ...
      <h1 class="space-top-half">Sillas industriales</h1>
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
          ...
          <div class="shop-bar">
            <div class="column">
              ...
              <span class="text-gray">Cantidad de Productos:</span> <?php 
                                
                                if ($result = mysqli_query($link, "SELECT id, modelo FROM sillasindustriales ORDER BY id")) {
          ...
          <div class="row">
          <?php
$sentencia=$pdo->prepare("SELECT * FROM `sillasindustriales` ORDER BY precio desc");
$sentencia->execute();
  ...
  ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="shop-item">
                ...
                <a href="descripcion.php?id=<?php echo  $producto ['id'];  ?>&pag=7" class="item-link"></a>
                  <img src="img/FOTOS OFFICE CLASS/SILLAS INDUSTRIALES/<?php echo  $producto ['modelo'];  ?>.png"  style="width:190px; height: 318px;" alt="Shop item">
