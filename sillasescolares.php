...
<?php include 'cavecera.php'?>
    ...
    <section class="container-fluid padding-top-3x padding-bottom-3x">
      ...
      <h1 class="space-top-half">Sillas escolares</h1>
     ...
     <!-- .col-md-3.col-sm-4 -->
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
          ...
          <div class="shop-bar">
            <div class="column">
              ...
              <span class="text-gray">Cantidad de Productos:</span> <?php 
                                ...
                                if ($result = mysqli_query($link, "SELECT id, modelo FROM sillasescolares ORDER BY id")) {
          ...
          <div class="row">
          <?php
$sentencia=$pdo->prepare("SELECT * FROM `sillasescolares` ORDER BY precio desc");
$sentencia->execute();
  ...
  ?>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
              <div class="shop-item">
                ...
                <a href="descripcion.php?id=<?php echo  $producto ['id'];  ?>&pag=9" class="item-link"></a>
                  <img src="img/FOTOS OFFICE CLASS/SILLAS ESCOLARES/<?php echo  $producto ['modelo'];  ?>.png" 
