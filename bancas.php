...
include 'cavecera.php'?>
    ...
    <section class="container-fluid padding-top-3x padding-bottom-3x">
      ...
      <h1 class="space-top-half">Sillas ejecutivas</h1>
      ...
      <div class="row padding-top">
        ...
        <div class="col-lg-10 col-md-9 col-sm-8">
          ...
          <div class="shop-bar">
            <div class="column">
              ...
              <span class="text-gray">Cantidad de Articulos:</span> <?php 
                                ...
                                if ($result = mysqli_query($link, "SELECT id, modelo FROM vancas ORDER BY precio desc")) {
          ...
          <div class="row">
<?php
$sentencia=$pdo->prepare("(select `precio`, `nombre` from `vancas` where `precio` between 200 and 1000) 
union (select `precio`, `nombre` from `sillasdevisitantes` where `precio` between 2002 and 3000)
union (select `precio`,`nombre` from `sillasoperativas` where precio between 2000 and 10000)
");
$sentencia=$pdo->prepare("SELECT * FROM `vancas` ORDER BY precio desc");
$sentencia->execute();
...
<?php foreach($listaProductos as $producto)
{
  ...
  <div class="col-lg-3 col-md-4 col-sm-6">
    ...
    <a href="descripcion.php?id=<?php echo  $producto ['id'];  ?>&pag=1" class="item-link"></a>
      <img src="img/FOTOS OFFICE CLASS/todas/<?php echo  $producto ['modelo'];  ?>.png" 
      style="width:190px; height: 318px;" 
        alt="Shop item"
        heig="317px"
      data-toggle="popover"
      data-trigger="hover"
      data-content="<?php echo  $producto ['modelo'];?>"
      >
